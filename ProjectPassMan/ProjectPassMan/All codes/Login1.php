...
<head>
  <meta charset="UTF-8">
  <title>Minimal Sign In / Sign Up From | Webdevtrick.com</title>
...
body .container .half.bg {
  background-image: url("https://images.unsplash.com/photo-1584985429926-08867327d3a6?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8a2V5fGVufDB8fDB8&ixlib=rb-1.2.1&w=1000&q=80");
         ...
         <div class="content">
             <div class="signin-cont cont">
                 <form  method="post" enctype="multipart/form-data">
                     <input type="text" name="user_name" id="name" class="inpt" required="required" placeholder="User Name">
                     <label for="email">Your email</label>
                     <input type="password" id="password" class="inpt" name="password" required="required" placeholder="Your password"/>
                     ...
                     <input type="checkbox" id="remember" class="checkbox" checked>
                         ...
                         <input type="submit" value="Log in" class="submit">
                          ...
                          <br>
                         <a style="text-decoration: none;" href="Signup1.php"><input type="button" style="text-decoration: none;"value="Sign Up" class="submit"></a>
