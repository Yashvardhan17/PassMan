...
<section class="container">
     <article class="half">
         <h1>PassMan</h1>
         <div class="tabs">
             <span class="tab signin active"><a href="#signin">Sign up</a></span>
                 ...
                 <form  method="post" enctype="multipart/form-data">
                     ...
                     <input type="checkbox" id="remember" class="checkbox" checked>
                         ...
                         <input type="submit" value="Sign up" class="submit">
                          ...
                          <br>
                         <a style="text-decoration: none;" href="Login1.php"><input type="button" style="text-decoration: none;"value="Log In" class="submit"></a>
